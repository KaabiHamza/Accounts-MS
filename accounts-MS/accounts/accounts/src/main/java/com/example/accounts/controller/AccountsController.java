...
public class AccountsController {
    ...
    public CustomerDetails myCustomerDetails(@RequestHeader("eazybank-correlation-id") String correlationId,
        ...
        String nodeJSUrl = "http://localhost:3000/send-email";
        HttpHeaders headers = new HttpHeaders();
        headers.setContentType(MediaType.APPLICATION_JSON);
        String requestBody = "{\"to\": \"ahmed.hmani@esprit.tn\", \"subject\": \"Test Email\", \"text\": \"Hello, this is a test email from the Notification Service.\"}";
        HttpEntity<String> requestEntity = new HttpEntity<>(requestBody, headers);
        ResponseEntity<String> response = restTemplate.postForEntity(nodeJSUrl, requestEntity, String.class);
